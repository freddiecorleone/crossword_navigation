...
from .types import Grid, EntryId, ProbabilityModel, SimConfig
from .value import ValueFunction
from typing import Optional

class Policy(Protocol):
    def plan_epoch(self, grid: Grid, model: ProbabilityModel, config: Optional[SimConfig] = None) -> List[EntryId]: ...
    def wants_hint(self, grid: Grid, model: ProbabilityModel, config: Optional[SimConfig] = None) -> bool:
        return False
    def name(self) -> str: ...
